...
import br.com.passocurto.gestao_vagas.modules.candidate.useCases.ListAllJobsByFilterUseCase;
...
public class CandidateController {
    ...
    @GetMapping("/")
    @PreAuthorize("hasRole('candidate')")
    @Operation(summary = "Cadastro das vagas", description = "Essa função é responsavel por cadastra as vagas da empresa")
    @ApiResponses({
            @ApiResponse(responseCode = "200", content = {
